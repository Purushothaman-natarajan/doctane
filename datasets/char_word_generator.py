...
from doctane.utils.io_utils import tensor_from_pil
from doctane.utils.fonts import get_font

from doctane.datasets.abstract_dataset import AbstractDataset
...
class CharacterGenerator(AbstractDataset):
    def __init__(
        self,
        vocab: str,
        num_samples: int,
...
class WordGenerator(AbstractDataset):
    def __init__(
        self,
        vocab: str,
        min_chars: int,
